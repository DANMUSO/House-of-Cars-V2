...
.btn:hover {
    ...
    <tbody>
        ...
        @php
            ...
            // Sort payment schedule chronologically (installment #1 first, #24 last)
            $sortedSchedule = $agreement->paymentSchedule->sortBy('installment_number');
            
            // Alternative sorting options if needed:
            // $sortedSchedule = $agreement->paymentSchedule->sortBy('due_date'); // Earliest due dates first
            // $sortedSchedule = $agreement->paymentSchedule->sortByDesc('installment_number'); // Reverse order (#24 first)
        @endphp

...
<div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">Partial Paid Cars</h4>
                            </div>
                            <div class="flex-grow-1">
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge 
                            ...
                            @elseif($bid->status == 'Accepted') bg-success-subtle text-success 
                            @elseif($bid->status == 'Rejected') bg-danger-subtle text-danger 
                            @endif fw-semibold">
                            {{ $bid->status }}
                        </span>
                    </td>
                    ...
                    <td>
                    <button class="btn btn-success btn-sm won-bid" data-id="{{ $bid->id }}">Won Bid</button>
                    <br>
                    <br>

                    <button class="btn btn-danger btn-sm lost-bid" data-id="{{ $bid->id }}">Lost Bid</button>

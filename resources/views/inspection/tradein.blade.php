                                            ...
                                            <div class="header">
                                                <div class="company-info">
                                                    <div class="company-details">
                                                        <h4>Qloud Point Solutions</h4>
                                                        <h6 style="color:white">Westland<br>
                                                       P.O Box 625 - 00100, Nairobi - Kenya<br>
                                            ...
                                            <div class="inventory-section">
                                                ...
                                                <div class="conditions-section">
                                                    ...
                                                    <div class="dealer-info">INSPECTION NOTES</div>
                                                        ...
                                                        <div class="conditions">
                                                            <div class="condition-item">
                                                                <span class="condition-number">1.</span> Qloud Point Solutions Ltd will take precautionary security and safety measures to safeguard customers' property but Qloud Point Solutions Ltd will not be responsible for damage or loss of any vehicle while in Qloud Point Solutions Ltd premises.
                                                            </div>

                                                            <div class="condition-item">
                                                                <span class="condition-number">2.</span> Qloud Point Solutions Ltd will receive all payments on behalf of customer and remit the same to customer.
                                                            </div>

                                                            <div class="condition-item">
                                                                <span class="condition-number">3.</span> Qloud Point Solutions Ltd will acknowledge receipt of all vehicle and any extra such as tinted.
                                                            </div>

                                                            <div class="condition-item">
                                                                <span class="condition-number">4.</span> The Owner/Agent of the car indemnifies Qloud Point Solutions Ltd from any legal process for the receipt of the vehicles at the showroom & confirm that all taxes have been paid.
                                                            </div>

                                                            <div class="condition-item">
                                                                <span class="condition-number">5.</span> Qloud Point Solutions Ltd will advertise the vehicle in the media of their choice.
                                                            </div>

                                                            <div class="condition-item">
                                                                <span class="condition-number">6.</span> In the customer's vehicle with less or minor defects and in our history and if made difficult to avail vehicle, Qloud Point Solutions Ltd reserves the right to rectify such minor defects and recover the same from the customer provided that he shall not exceed Ksh 10,000 (Ten Thousand shillings only).
                                                            </div>

                                                            <div class="condition-item">
                                                                <span class="condition-number">7.</span> If the vehicle, while in the process of selling within Qloud Point Solutions Ltd receives a serious commitment from a potential buyer, the Customer (Car Owner/Agent) cannot withdraw the vehicle from Qloud Point Solutions Ltd premises and the buyer will be given a preference. 
                                                        ...
                                                        <div class="signature-section">
                                                            <div class="signature-box">
                                                                ...
                                                                <div class="signature-line"></div>
                                                                <div class="dealer-info">Qloud Point Solutions Ltd</div>
                                                            </div>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-dark" id="demandLetterContent">
                ...
                <div class="text-center mb-4">
                    <img src="{{asset('dashboardv1/assets/images/houseofcars.png')}}" alt="Qloud Point Solutions LTD" style="height: 300px; width: auto;">
                </div>
...
function generateComprehensivePDF(clientName, agreementId) {
    ...
    doc.text("Qloud Point Solutions LTD", 105, 60, { align: 'center' });

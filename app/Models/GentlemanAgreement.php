...
use Carbon\Carbon;
class GentlemanAgreement extends Model
{
    use HasFactory;

    protected $table ="gentlemanagreements";
    protected $fillable = [
        'client_name', 'phone_number', 'email', 'national_id', 'kra_pin', 'address',
        'car_type', 'car_id', 'imported_id', 'customer_id',
        'vehicle_price', 'deposit_amount', 'loan_amount',  
        'duration_months', 'monthly_payment','total_amount',
